...
function App() {
  ...
  const handleScroll = () => {
    ...
    const content = parallax.current.current / window.innerHeight;
    const currentOffset = Math.floor(content);
    const scrollTop = container.scrollTop;

    if (container) {
      if (content !== parseInt(currentOffset, 10)) {
  ...
  useEffect(() => {
    if (parallax.current) {
      // Pastikan container ada sebelum menambahkan event listener
      const container = parallax.current.container.current;
    ...
    <div className="flex items-center justify-center h-screen">
      ...
      >
        {/*<ParallaxLayer
          ...
          style={{
            backgroundImage: `url('/assets/frame/frame-37.png')`,
        ...
        <ParallaxLayer
          ...
          style={{
            backgroundImage: `url('/assets/frame/frame-19.png')`,
            backgroundSize: "100% 100%",
            backgroundRepeat: "no-repeat", // Tidak mengulang gambar
            backgroundPosition: "center center", // Posisikan gambar di tengah
            width: "100%", // Lebar penuh layar
        ...
        <ParallaxLayer
          ...
          style={{
            backgroundImage: `url('/assets/frame/frame-16.png')`,
            backgroundSize: "100% 100%",
            backgroundRepeat: "no-repeat", // Tidak mengulang gambar
            backgroundPosition: "center center", // Posisikan gambar di tengah
            width: "100%", // Lebar penuh layar
        ...
        <ParallaxLayer
          ...
          speed={0}
          style={{
            backgroundImage: `url('/assets/frame/frame-15.png')`,
            backgroundSize: "100% 100%",
            backgroundRepeat: "no-repeat", // Tidak mengulang gambar
            backgroundPosition: "center center", // Posisikan gambar di tengah
            width: "100%", // Lebar penuh layar
        ...
        <ParallaxLayer
          ...
          speed={0}
          style={{
            backgroundImage: `url('/assets/frame/frame-18.png')`,
            backgroundSize: "100% 100%",
            backgroundRepeat: "no-repeat", // Tidak mengulang gambar
            backgroundPosition: "center center", // Posisikan gambar di tengah
            width: "100%", // Lebar penuh layar
        ...
        <ParallaxLayer
          ...
          speed={0}
          style={{
            backgroundImage: `url('/assets/frame/frame-5.png')`,
            backgroundSize: "100% 100%",
            backgroundRepeat: "no-repeat", // Tidak mengulang gambar
            backgroundPosition: "center center", // Posisikan gambar di tengah
            width: "100%", // Lebar penuh layar
        ...
        >
          ...
          >
            <img
              src="/assets/frame/background/cover-8.png"
              className="scale-150"
            />
          </animated.div>
          <animated.div
        ...
        >
          ...
          <div className="mt-10">
            ...
            {/*<fieldset className="grid gap-3 w-fit mx-3 pb-3 rounded-md bg-[#F8F4EC]/90 backdrop-blur-md ">
              <label
                htmlFor="ucapan"
                className="font-edwardian text-5xl text-center pb-4 pt-2 border-b-2 mb-6 text-gray-700 border-gray-700"
              >
                Dresscode
              </label>
              <ColorSelector />
              <p className="mt-5 text-center text-sm font-baskervville text-black">
                Pernikahan kami dilaksanakan di tempat terbuka (semi-outdoor),
                Silahkan gunakan pakaian terbaik yang membuatmu nyaman.
              </p>
            </fieldset>*/}
          </div>
        </ParallaxLayer>
